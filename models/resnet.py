...
#         # y = torch.var(x, dim=[2, 3], keepdim=True).view(b,c)
...
if __name__ == '__main__':
    ...
    model.conv1 = nn.Conv2d(48, 64, kernel_size=1, stride=1, padding=0, bias=False)
    model.fc1 = nn.Linear(512, 2)
    # print(model)
    summary(model, input_size=(1, 48, 111, 111), device='cpu')